...
@section('auth')
    <div class="px-30 pb-30">
        ...
        <form id="authLoginForm" action="{{ route('agent_check') }}" onsubmit="authLogin($(this))" method="post">
            ...
            <div class="row">
                ...
                <div class="col-12 text-center my-4">
                    <label>Don't have a account yet? <a href="{{ route('agent_signup') }}" class="text-info">Sign Up</a></label>
                </div>
            </div>
